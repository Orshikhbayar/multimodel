...
const fixtures = {
  ...
  mediumMessage: {
    ...
    content:
      "I'm doing great! How can I help you today? I'm capable of helping with many tasks including coding, writing, analysis, and more.",
    createdAt: Date.now(),
    runs: [
      {
        id: "run-medium-1",
    ...
    runs: [
      {
        ...
        text: Array.from(
          { length: 50 },
          (_, i) => `Line ${i + 1}: This is a sample line of text.`,
        ).join("\n"),
      },
    ],
  },
