...
describe("conversationStore", () => {
  ...
  describe("addMessages", () => {
    it("adds messages to a conversation", () => {
      const { createConversation, addMessages } =
        useConversationStore.getState();
  ...
  describe("appendRunChunk", () => {
    it("appends streaming chunks to a run", () => {
      const { createConversation, addMessages, appendRunChunk } =
        useConversationStore.getState();
  ...
  describe("completeRun", () => {
    it("marks a run as done with final payload", () => {
      const { createConversation, addMessages, completeRun } =
        useConversationStore.getState();
  ...
  describe("markRunError", () => {
    it("marks a run as errored", () => {
      const { createConversation, addMessages, markRunError } =
        useConversationStore.getState();
  ...
  describe("removeConversation", () => {
    it("removes a conversation and selects next one", () => {
      const { createConversation, removeConversation } =
        useConversationStore.getState();
