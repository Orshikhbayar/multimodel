...
export function TopUpModal() {
  ...
  return (
    <Dialog open={ui.topUpModalOpen} onOpenChange={(open) => !open && closeTopUpModal()}>
      <DialogContent className="max-w-lg">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {TOP_UP_PACKS.map((pack) => {
            ...
            return (
              <div key={pack.id} className="rounded-xl border bg-muted/30 p-4 text-sm">
                ...
                <p className="text-xs text-muted-foreground">Instant credits - no expiry</p>
                <Button
